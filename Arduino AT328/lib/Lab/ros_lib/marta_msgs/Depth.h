#ifndef _ROS_marta_msgs_Depth_h
#define _ROS_marta_msgs_Depth_h
...
namespace marta_msgs
{
  ...
  class Depth : public ros::Msg
  {
    ...
    const char * getType(){ return PSTR( "marta_msgs/Depth" ); };
    const char * getMD5(){ return PSTR( "ecaa3eb2663713277f30af306d8347d1" ); };
