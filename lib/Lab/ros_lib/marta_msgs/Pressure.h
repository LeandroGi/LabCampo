#ifndef _ROS_marta_msgs_Pressure_h
#define _ROS_marta_msgs_Pressure_h
...
namespace marta_msgs
{
  ...
  class Pressure : public ros::Msg
  {
    ...
    const char * getType(){ return PSTR( "marta_msgs/Pressure" ); };
    const char * getMD5(){ return PSTR( "cc86d3e590cd90e822f975defafdf965" ); };
