#ifndef _ROS_marta_msgs_Distance_h
#define _ROS_marta_msgs_Distance_h
...
namespace marta_msgs
{
  ...
  class Distance : public ros::Msg
  {
    ...
    const char * getType(){ return PSTR( "marta_msgs/Distance" ); };
    const char * getMD5(){ return PSTR( "4c739b0ad83c2914df6d41fe1b87d25f" ); };
